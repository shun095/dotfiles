...
execute join(['function! vital#_mymisc#Async#Lambda#import() abort', printf("return map({'_vital_depends': '', 'filter': '', 'filter_f': '', 'reduce': '', 'reduce_f': '', '_vital_created': '', 'map': '', 'map_f': '', '_vital_loaded': ''}, \"vital#_mymisc#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
