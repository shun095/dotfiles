...
execute join(['function! vital#_mymisc#Lambda#import() abort', printf("return map({'throw': '', 'filter_f': '', 'echomsg': '', 'echo': '', 'pass': '', 'reduce': '', 'unlet': '', 'void': '', 'let': '', 'map': '', 'map_f': '', 'filter': '', 'if': '', 'reduce_f': ''}, \"vital#_mymisc#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
