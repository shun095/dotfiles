...
let s:p.inactive.right = [ [ s:white, s:grey ], [ s:white, s:grey ] ]
let s:p.insert.left = [ [ s:black, s:blue, 'bold' ], [ s:white, s:grey ] ]
let s:p.insert.right = [ [ s:black, s:white ], [ s:white, s:grey ] ]
let s:p.replace.left = [ [ s:black, s:red, 'bold' ], [ s:white, s:grey ] ]
let s:p.replace.right = [ [ s:black, s:white ], [ s:white, s:grey ] ]
let s:p.visual.left = [ [ s:black, s:purple, 'bold' ], [ s:white, s:grey ] ]
let s:p.visual.right = [ [ s:black, s:white ], [ s:white, s:grey ] ]
...
let g:lightline#colorscheme#onedark_custom#palette = lightline#colorscheme#flatten(s:p)
